...
import PaymentTermsList from '../../components/setting/PaymentTermsList';
import PaymentTermNew from '../../components/setting/PaymentTermNew';
...
class PaymentTerms extends Component {
  ...
  render() {
    const { currentAccountLoading, paymentTerms, paymentTermsLoading } = this.props;
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(PaymentTerms));
